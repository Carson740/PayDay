...
Warninglabel = Label(mw, text="If a box does not apply to you, you may leave it empty.", font='none 12', bg='#B8B8B8')
Warninglabel.grid(row=1, column=0)

Label(mw, text='Enter your paycheck amount. If you have multiple, separate by commas: ', bg='#B8B8B8')\
